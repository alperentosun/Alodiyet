...
<body>
    ...
    <div class="circle-bg-top-right">
        <img src="/alodiyet/alodiyetresimler/giris/giris-circle.png" alt="Background Circle Top Right">
    </div>
    <div class="circle-bg-bottom-left">
        <img src="/alodiyet/alodiyetresimler/giris/giris-circle.png" alt="Background Circle Bottom Left">
    </div>
    <div class="login-container">
        ...
        <div class="right-side">
            ...
            <div class="login-form">
                ...
                <p class="form-subtitle">Lütfen Hesap Bilgilerinizi Giriniz</p>
                ...
                <form action="#" method="post">
                    ...
                    <p style="text-align: center; margin-bottom: 10px;">yada</p>
                    <div class="social-icons">
                        <a href="#" class="social-icon facebook-icon">
                            <img src="/alodiyet/alodiyetresimler/facebook.png" alt="Facebook">
                        </a>
                        <a href="#" class="social-icon google-icon">
                            <img src="/alodiyet/alodiyetresimler/google.png" alt="Google">
                        </a>
                        <a href="#" class="social-icon linkedin-icon">
                            <img src="/alodiyet/alodiyetresimler/linkedin.png" alt="LinkedIn">
                        </a>
                    </div>
                </div>
